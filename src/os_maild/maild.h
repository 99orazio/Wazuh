...
#define SMS_SUBJECT         "BSQ Cyber Security %d - %d - %s"
#define MAIL_SUBJECT        "BSQ Cyber Security - %s - Notifica allarme livello %d"
#define MAIL_SUBJECT_FULL   "BSQ Cyber allarme - %s - Livello %d - %s"
...
#define MAIL_BODY           "\r\n NOTIFICA BSQ CYBER.\r\n" \
                            "%s\r\n\r\n" \
                            "Ricevuto da: %s\r\n" \
                            "Regola: %d attivata (livello %d) -> \"%s\"\r\n" \
                            "%s" \
                            "%s" \
                            "%s" \
                            "Sezione del log(s):\r\n\r\n%s\r\n" \
                            "\r\n\r\n --BSQ CYBER SECURITY TEAM\r\n\r\n\r\n"
#else
#define MAIL_BODY           "\r\n NOTIFICA BSQ CYBER.\r\n" \
                            "%s\r\n\r\n" \
                            "Ricevuto da: %s\r\n" \
